...
/**
 * Mock request for uploads.
 */
public class MockRequest implements StaplerRequest2 {
     ...
     */
    public MockRequest(byte[] buffer, String contentType) {
        this.buffer = buffer;
    ...
    public FileItem<?> getFileItem2(String name) throws ServletException, IOException {
        if (buffer != null && StringUtils.equals(name, "avatar")) {
            return new FileItem() {
                @Override
                public InputStream getInputStream() {
                    return MockRequest.this.getInputStream();
                }

                @Override
                public String getContentType() {
                    return MockRequest.this.getContentType();
                }
                ...
                @Override
                public long getSize() {
                    return MockRequest.this.getContentLength();
                }
